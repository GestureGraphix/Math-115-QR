...
\sol{
	...
	\begin{center}
		\[ \left( \frac{r_{i}}{2} \right)^{2}=  3^{2} - h_{i}^{2} \] 
		\[ \frac{r_{i}^{2}}{4} = 3^{2} - h_{i}^{2}\] 
		\[ r_{i}^{2} = 4(3)^{2} - 4h_{i}^{2} \]
		\[ r_{i} = \sqrt{36 - 4h_{i}^{2}}\]  
	\end{center}
	$\int_{0}^{7}  \left(\sqrt{36 - 4h_{i}^{2}}\right) dh $ \\
	$\pi \int_{0}^{7}  36 - 4h_{i}^{2} dh $ 
